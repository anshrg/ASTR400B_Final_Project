...
# and simulation snapshot
    ...
    def COM_P(self, delta=0.1, volDec=2):
        ...
        volDec: `float, optional`
            factor by which to iteratively shrink sphere enclosing mass particles
            used to iteratively determine COM position. Default is 2
...
if __name__ == '__main__' : 
    ...
    # Q4:  The iterative procedure is necessary because as galaxies interact their stars get thrown to large radii with different speeds. Tidal tails are not spherically symmetric; this can cause the COM position calculation to be really off if you are using all the particles at large radii. 
